...
public class LinkRecord extends UpdatableRecordImpl<LinkRecord> implements Record10<Long, String, String, String, String, Long, Long, OffsetDateTime, OffsetDateTime, String> {
    ...
    @Override
    @NotNull
    public Row10<Long, String, String, String, String, Long, Long, OffsetDateTime, OffsetDateTime, String> valuesRow() {
    ...
    @Override
    @NotNull
    public LinkRecord value10(@NotNull String value) {
        setCreatedBy(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public LinkRecord values(@Nullable Long value1, @NotNull String value2, @Nullable String value3, @Nullable String value4, @Nullable String value5, @Nullable Long value6, @Nullable Long value7, @NotNull OffsetDateTime value8, @NotNull OffsetDateTime value9, @NotNull String value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    @ConstructorProperties({ "id", "url", "questionId", "ownerName", "repositoryName", "answerCount", "commitsCount", "lastCheckTime", "createdAt", "createdBy" })
    public LinkRecord(@Nullable Long id, @NotNull String url, @Nullable String questionId, @Nullable String ownerName, @Nullable String repositoryName, @Nullable Long answerCount, @Nullable Long commitsCount, @NotNull OffsetDateTime lastCheckTime, @NotNull OffsetDateTime createdAt, @NotNull String createdBy) {
        super(Link.LINK);
