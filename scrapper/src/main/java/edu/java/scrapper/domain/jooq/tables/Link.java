...
@SuppressWarnings({"all", "unchecked", "rawtypes", "this-escape", "EmptyLineSeparator", "ImportOrder"})
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, String> QUESTION_ID =
        createField(DSL.name("QUESTION_ID"), SQLDataType.VARCHAR(1000000000), this, "");

    /**
     * The column <code>LINK.OWNER_NAME</code>.
     */
    public final TableField<LinkRecord, String> OWNER_NAME =
        createField(DSL.name("OWNER_NAME"), SQLDataType.VARCHAR(1000000000), this, "");

    /**
     * The column <code>LINK.REPOSITORY_NAME</code>.
     */
    public final TableField<LinkRecord, String> REPOSITORY_NAME =
        createField(DSL.name("REPOSITORY_NAME"), SQLDataType.VARCHAR(1000000000), this, "");

    /**
     * The column <code>LINK.ANSWER_COUNT</code>.
     */
    public final TableField<LinkRecord, Long> ANSWER_COUNT =
        createField(DSL.name("ANSWER_COUNT"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>LINK.COMMITS_COUNT</code>.
     */
    public final TableField<LinkRecord, Long> COMMITS_COUNT =
        createField(DSL.name("COMMITS_COUNT"), SQLDataType.BIGINT, this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function11<? super Long, ? super String, ? super String, ? super String, ? super String, ? super Long, ? super Long, ? super OffsetDateTime, ? super OffsetDateTime, ? super OffsetDateTime, ? super String, ? extends U> from) {
    ...
    public <U> SelectField<U> mapping(
        Class<U> toType,
        Function11<? super Long, ? super String, ? super String, ? super String, ? super String, ? super Long, ? super Long, ? super OffsetDateTime, ? super OffsetDateTime, ? super OffsetDateTime, ? super String, ? extends U> from
    ) {
