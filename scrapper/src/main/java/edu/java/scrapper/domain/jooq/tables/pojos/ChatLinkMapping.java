...
public class ChatLinkMapping implements Serializable {
    ...
    public ChatLinkMapping(ChatLinkMapping value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final ChatLinkMapping other = (ChatLinkMapping) obj;
        if (this.chatId == null) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ChatLinkMapping (");
