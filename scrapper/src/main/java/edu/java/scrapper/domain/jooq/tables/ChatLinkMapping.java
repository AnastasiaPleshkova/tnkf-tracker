...
public class ChatLinkMapping extends TableImpl<ChatLinkMappingRecord> {
     ...
     */
    public final TableField<ChatLinkMappingRecord, Long> CHAT_ID = createField(DSL.name("CHAT_ID"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>CHAT_LINK_MAPPING.LINK_ID</code>.
     */
    public final TableField<ChatLinkMappingRecord, Long> LINK_ID = createField(DSL.name("LINK_ID"), SQLDataType.BIGINT.nullable(false), this, "");
